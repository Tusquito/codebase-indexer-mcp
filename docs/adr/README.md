...
| [0030](0030-migrate-mcp-server-to-dotnet10.md) | Migrate MCP server runtime from Python to C# .NET 10 | Accepted (phases 1–6; Phase 7 pending Accept after merge) | 2026-07-12 |
