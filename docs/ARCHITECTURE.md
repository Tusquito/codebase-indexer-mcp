...
| HTTP server (.NET — ADR 0030 Phase 1+ scaffold) | `src/CodebaseIndexer.Host/Program.cs` | ASP.NET Core MCP stub (`MapMcp("/mcp")`), OTel via ServiceDefaults; full tool parity from Phase 2+ |
