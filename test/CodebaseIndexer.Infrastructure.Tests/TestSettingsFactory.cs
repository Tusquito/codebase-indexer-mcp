...
internal static class TestSettingsFactory
{
    ...
    public static EmbeddingOptions CreateEmbeddingOptions(int? denseVectorSize = null) => new()
    {
        ...
        RerankEnabled = false,
        ColbertEmbedModel = "colbert-ir/colbertv2.0",
        RerankPrefetch = 100,
        RerankMaxQueryTokens = 0,
        RerankAdaptiveEnabled = false,
        RerankAdaptiveGap = 0.02f,
        MaxDenseTokens = 0,
        MaxSparseTokens = 0,
    ...
    public static ColbertOptions CreateColbertOptions() => new()
    {
        EmbedModel = "colbert-ir/colbertv2.0",
        EmbedBackend = "onnx",
        ...
        DiscoveryOptions discovery)
    {
        return new Dictionary<string, string?>
        {
            ...
            [$"{EmbeddingOptions.SectionName}:ColbertEmbedModel"] = embedding.ColbertEmbedModel,
            [$"{EmbeddingOptions.SectionName}:RerankPrefetch"] = embedding.RerankPrefetch.ToString(),
            [$"{EmbeddingOptions.SectionName}:RerankMaxQueryTokens"] = embedding.RerankMaxQueryTokens.ToString(),
            [$"{EmbeddingOptions.SectionName}:RerankAdaptiveEnabled"] = embedding.RerankAdaptiveEnabled.ToString().ToLowerInvariant(),
            [$"{EmbeddingOptions.SectionName}:RerankAdaptiveGap"] = embedding.RerankAdaptiveGap.ToString(System.Globalization.CultureInfo.InvariantCulture),
